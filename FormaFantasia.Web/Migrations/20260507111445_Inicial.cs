    ...
    public partial class Inicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EncomendaProduto", x => new { x.EncomendasId, x.ProdutosId });
                    table.ForeignKey(
                        name: "FK_EncomendaProduto_Encomendas_EncomendasId",
                        column: x => x.EncomendasId,
                        principalTable: "Encomendas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EncomendaProduto_Produtos_ProdutosId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EncomendaProduto_ProdutosId",
